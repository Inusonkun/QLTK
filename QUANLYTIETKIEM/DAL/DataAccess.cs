...
using System.Data;
using QUANLYTIETKIEM.SO;


namespace QUANLYTIETKIEM.DAL
{
    /// <summary>
    ...
    public class DataAccess
    {
        ...
        //Stored procedure áp dụng trên cách này, đảy value vào theo dạng sql parameter, chống đc sql injection so vs cái kiểu cộng chuỗi đang làm
        public int ExecuteData(string sSql, List<KeyValuePair<string, object>> ParaMeterCollection)
        {
            try
            {
                DbConnection cnn = oFactory.CreateConnection();
