...
namespace QUANLYTIETKIEM.SO
{
    class PhanQuyen
    {
        ...
        private static string _sPubItemMnu = ";MnuHeThong;MnuItemLogin;MnuItemExit;".ToUpper();
        /// <summary>
        ...
        public static void HideAll()
        {
            ...
            for (int i = 0; i < frm.menuStrip1.Items.Count; i++)
            {
                if (frm.menuStrip1.Items[i].GetType().ToString() == "System.Windows.Forms.ToolStripMenuItem")
                {
                    //Bắt đầu từ menu cấp 1
                    ToolStripMenuItem item1 = (ToolStripMenuItem)frm.menuStrip1.Items[i];
